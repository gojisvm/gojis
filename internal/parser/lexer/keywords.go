...
var (
	...
	allReservedWords = map[string]token.Type{
		...
		ReservedWordEnum:       token.dWordEnum,
		ReservedWordImplements: token.dWordImplements,
		ReservedWordPackage:    token.dWordPackage,
		ReservedWordProtected:  token.dWordProtected,
		ReservedWordInterface:  token.dWordInterface,
		ReservedWordPrivate:    token.dWordPrivate,
		ReservedWordPublic:     token.dWordPublic,
	}
)
